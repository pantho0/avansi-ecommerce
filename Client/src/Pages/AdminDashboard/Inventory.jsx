        ...
        products.map(product=><tr key={product._id}>
          <td>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm opacity-50">{product?.parent_category}</div>
              </div>
            </div>
          </td>
          <td>
          ...
          <th>
            <div className="flex gap-3">
              ...
              <LuFileEdit onClick={handleUpdate} size={20} className="cursor-pointer" color="green"/>
              </div>
              <div className="tooltip" data-tip="delete">
              <MdDelete onClick={handleDelete} size={20} className="cursor-pointer" color="red"/>
              </div>
            </div>
          </th>
        </tr>)
